...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
//#define ENABLE_BUTTON_POOL
#define ENABLE_BUTTON_INTERRUPTION
/* USER CODE END PD */
...
/* USER CODE BEGIN PFP */
#ifdef ENABLE_BUTTON_INTERRUPTION
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	#ifdef ENABLE_BUTTON_POOL
	xGpioInitStruct.Mode = GPIO_MODE_INPUT;
	#elif defined(ENABLE_BUTTON_INTERRUPTION)
