...
C_SRCS += \
../Core/MQTT/paho_timer.c 

OBJS += \
./Core/MQTT/paho_timer.o 

C_DEPS += \
./Core/MQTT/paho_timer.d 


# Each subdirectory must supply rules for building sources it contributes
Core/MQTT/%.o Core/MQTT/%.su: ../Core/MQTT/%.c Core/MQTT/subdir.mk
...
clean-Core-2f-MQTT:
	-$(RM) ./Core/MQTT/paho_timer.d ./Core/MQTT/paho_timer.o ./Core/MQTT/paho_timer.su
