...
C_SRCS += \
../Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.c 

OBJS += \
./Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.o 

C_DEPS += \
./Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/%.o Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/%.su: ../Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/%.c Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-paho-2e-mqtt-2e-embedded-2d-c-2f-MQTTClient-2d-C-2f-samples-2f-linux

clean-Middlewares-2f-Third_Party-2f-paho-2e-mqtt-2e-embedded-2d-c-2f-MQTTClient-2d-C-2f-samples-2f-linux:
	-$(RM) ./Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.d ./Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.o ./Middlewares/Third_Party/paho.mqtt.embedded-c/MQTTClient-C/samples/linux/stdoutsub.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-paho-2e-mqtt-2e-embedded-2d-c-2f-MQTTClient-2d-C-2f-samples-2f-linux
