...
/* USER CODE BEGIN ET */
typedef enum {
  WIFI_ENCRYPTION_OPEN = 0x00,
  WIFI_ENCRYPTION_WEP = 0x01,
  WIFI_ENCRYPTION_WPA_PSK = 0x02,
  WIFI_ENCRYPTION_WPA2_PSK = 0x03,
  WIFI_ENCRYPTION_WPA_WPA2_PSK = 0x04,
}WIFI_Encryption_t;
/* USER CODE END ET */
