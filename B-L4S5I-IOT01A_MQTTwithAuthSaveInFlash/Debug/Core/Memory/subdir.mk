...
C_SRCS += \
../Core/Memory/flash_l4.c \
../Core/Memory/heap.c 

OBJS += \
./Core/Memory/flash_l4.o \
./Core/Memory/heap.o 

C_DEPS += \
./Core/Memory/flash_l4.d \
./Core/Memory/heap.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Memory/%.o Core/Memory/%.su: ../Core/Memory/%.c Core/Memory/subdir.mk
...
clean: clean-Core-2f-Memory

clean-Core-2f-Memory:
	-$(RM) ./Core/Memory/flash_l4.d ./Core/Memory/flash_l4.o ./Core/Memory/flash_l4.su ./Core/Memory/heap.d ./Core/Memory/heap.o ./Core/Memory/heap.su

.PHONY: clean-Core-2f-Memory
